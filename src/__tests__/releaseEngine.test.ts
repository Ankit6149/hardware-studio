...
function sampleProject(): Project {
  return {
    ...
    requirements: [{
      id: 'req_release_ready',
      title: 'Release-ready functional requirement',
      description: 'The release candidate must satisfy the reviewed acceptance criterion.',
      type: 'Functional',
      priority: 'High',
      status: 'Verified',
      acceptanceCriteria: ['Reviewed validation evidence passes.'],
      linkedArchitectureNodeIds: [],
      linkedComponentIds: [],
      linkedFirmwareModuleIds: [],
      linkedTestIds: ['test_release_ready'],
      risks: [],
    }],
    validationTests: [{
      id: 'test_release_ready',
      name: 'Release readiness validation',
      stage: 'DVT',
      category: 'Requirement',
      linkedRequirementIds: ['req_release_ready'],
      linkedArchitectureNodeIds: [],
      linkedComponentIds: [],
      linkedNetIds: [],
      linkedFirmwareModuleIds: [],
      steps: [],
      measurements: [],
      passCriteria: ['Reviewed validation evidence passes.'],
      status: 'Passed',
      evidence: [],
    }],
    validationRuns: [{
      id: 'run_release_ready',
      testId: 'test_release_ready',
      runNumber: 1,
