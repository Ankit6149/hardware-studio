...
export const exportProjectMarkdown = (project: Project) => {
  ...
  try {
    let md = `# Hardware Studio connected engineering workspace — ${project.projectName} Project Report\n\n`;
    ...
    const views = [
      ...
      { id: 'hardware-studio', name: 'Hardware Studio External Integration' }
    ];
    ...
    // Footer
    md += `---\n*Generated by Hardware Studio connected engineering workspace. Copying or redistribution is permitted.*`;
