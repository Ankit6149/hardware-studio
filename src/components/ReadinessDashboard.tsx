      ...
      <div className="mx-auto max-w-6xl space-y-4">
        <section className="grid gap-4 lg:grid-cols-[minmax(0,1fr)_260px]">
          <div className="border-l-4 border-slate-950 bg-white p-4">
            <p className="text-[9px] font-semibold uppercase tracking-[0.12em] text-slate-400">What can this project safely do next?</p>
            <p className="mt-2 text-[9px] font-semibold uppercase tracking-[0.12em] text-slate-400">{nextAction.eyebrow}</p>
            <h1 className="mt-1 text-lg font-semibold tracking-tight text-slate-950">{nextAction.title}</h1>
            <p className="mt-2 max-w-3xl text-xs leading-5 text-slate-600"><strong className="font-semibold text-slate-700">Consequence:</strong> {nextAction.detail}</p>
        ...
        <section className="border border-slate-200 bg-white p-4" aria-label="Capability gate evidence">
